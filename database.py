...
def add_question():
    questions = [
        ...
        ('¿Cuándo es posible sacar a-gua con una red?', 'Cuando el agua está congelada', 'Cuando no hay peces', 'Cuando los peces de colores nadan lejos', 'Cuando la red se rompe'),
...
def get_next_question(id_question=0, quiz_id):
    pass